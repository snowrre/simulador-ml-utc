        ...
        <div className="max-w-7xl mx-auto py-8 sm:py-12 px-4 space-y-8 sm:space-y-12">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                <div>
                    ...
                    <button 
                        onClick={() => window.dispatchEvent(new CustomEvent('start-ml-tutorial', { detail: '/simulador/modelo/knn' }))}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div className="bg-white dark:bg-gray-900 rounded-[2.5rem] sm:rounded-[3rem] p-6 sm:p-8 border border-gray-100 dark:border-white/10 shadow-sm">
                                <div className="flex justify-between items-center mb-6">
                                    <h4 className="text-lg font-black text-navy-slate dark:text-white uppercase italic">Métricas de Rendimiento</h4>
                                    <ExportButton 
                                        modelName="KNN" 
