...
import DecisionTreeManager from '@/components/simulador/DecisionTreeManager';
import WizardStepper from '@/components/simulador/WizardStepper';
import Link from 'next/link';

export default function DecisionTreeModelPage() {
    return (
            ...
            <div className="bg-white dark:bg-gray-900 border-b border-gray-100 dark:border-gray-800 pt-32 pb-8">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-end gap-6">
                        <div>
                            <h1 className="text-4xl font-black text-navy-slate dark:text-white uppercase italic tracking-tighter">Entrenamiento: Árbol de Decisión</h1>
                            <p className="text-gray-500 dark:text-gray-400 mt-2 font-medium">Lógica condicional estructurada en árbol. Respaldado por el servidor Python + Scikit-Learn.</p>
                        </div>
                    </div>
                </div>
            </div>
